...
public class MkxthreatPlanetaryShield extends BaseIndustry {
	...
	public void apply() {
		...
		demand(Commodities.HEAVY_MACHINERY, size - 4);
	...
	public static void applyVisuals(PlanetAPI planet) {
		...
		planet.getSpec().setShieldTexture(Global.getSettings().getSpriteName("industry", "mkxthreat_shield_texture"));
