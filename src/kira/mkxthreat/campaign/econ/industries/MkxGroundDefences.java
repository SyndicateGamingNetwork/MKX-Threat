...
public class MkxGroundDefences extends BaseIndustry {
    ...
    public void apply() {
        ...
        boolean hb = MkxIndustries.MKXHEAVYBATTERIES.equals(getId());
    ...
    public String getCurrentImage() {
        boolean batteries = MkxIndustries.MKXHEAVYBATTERIES.equals(getId());
        if (batteries) {
